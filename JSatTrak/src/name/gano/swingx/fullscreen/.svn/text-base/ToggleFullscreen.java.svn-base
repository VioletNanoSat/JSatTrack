...
public class ToggleFullscreen extends JFrame {
	...
	private static final long serialVersionUID = 2190974473454108186L;
	...
	private transient DisplayMode dispMode = new DisplayMode(800, 600, 32, 60);
	
	//the original resolution before our program is run.
	private transient DisplayMode dispModeOld = null;
    ...
    private transient KeyAdapter keyAdp;
