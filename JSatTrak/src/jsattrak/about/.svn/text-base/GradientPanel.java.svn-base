...
public class GradientPanel extends JPanel {
	private static final long serialVersionUID = -2397892447295218325L;
...
//		int width = getWidth();
		...
		painter = new GradientPaint(0, 0, gradientEnd,
				0, (float) (height / 2.0), gradientStart);
		g2.setPaint(painter);
		g2.fill(g2.getClip());

		painter = new GradientPaint(0, (float) (height / 2.0), gradientStart,
				0, height, gradientEnd);
		g2.setPaint(painter);
		g2.fill(g2.getClip());
