        ...
        if(lastStateVector != null)
        {
            ...
            switch(goalInt)
            {
                ...
                case 14: // Latitude [deg]
                    ...
                    double[] lla = GeoFunctions.geodeticLLA_mjd(temePos, lastStateVector.state[0] - AstroConst.JDminusMJD - deltaTT2UTC); // tt-UTC = deltaTT2UTC
                ...
                case 15: // Longitude [deg]
                    ...
                    lla = GeoFunctions.geodeticLLA_mjd(temePos, lastStateVector.state[0] - AstroConst.JDminusMJD - deltaTT2UTC); // tt-UTC = deltaTT2UTC
