 ...
 * @author  sgano
 */
public class JCoverageDialog extends javax.swing.JPanel implements SatListener
{
    CoverageAnalyzer ca;
    ...
    public JCoverageDialog(CoverageAnalyzer ca, final Time currentJulianDate, JSatTrak app, Vector<J2DEarthPanel> twoDWindowVec)
    {
        initComponents();
        ...
        startTextField.setText(app.getCurrentJulianDate().getDateTimeStr());
    ...
    public void satRemoved(AbstractSatellite sat) {
        ((DefaultListModel)availSatList.getModel()).removeElement(sat.getName());
    }
...
private void runButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_runButtonActionPerformed
    ...
    HashMap<String, AbstractSatellite> tmpSatHash = new HashMap<String, AbstractSatellite>();
    for (String satName : app.getSatNames()) {
        tmpSatHash.put(satName, app.getSatellite(satName));
    }
    
    final HashMap<String, AbstractSatellite> tempSatHash = (HashMap<String, AbstractSatellite>)UnoptimizedDeepCopy.copy(tmpSatHash);
