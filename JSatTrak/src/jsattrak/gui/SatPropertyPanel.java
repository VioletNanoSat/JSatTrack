...
public class SatPropertyPanel extends javax.swing.JPanel implements java.io.Serializable
{
	...
	private static final long serialVersionUID = -1780446602548922741L;
    ...
    private void getSelectedPosVel(double[] pos, double[] vel)
    {
        switch(cartComboBox.getSelectedIndex())
        {
            ...
            case 2: // MOD
                ...
                // find transform
                CoordinateConversion.j2000toMOD(satProp.currentJulDate() - AstroConst.JDminusMJD,j2kpos,temp1,j2kvel,temp2);
                // copy results back
                copyArray(temp1, pos);
                copyArray(temp2, vel);
                break;
            case 3: // TOD
                ...
                temp2 = new double[3];
                // find transform
                CoordinateConversion.j2000toTOD(satProp.currentJulDate() - AstroConst.JDminusMJD,j2kpos,temp1,j2kvel,temp2);
                // copy results back
                copyArray(temp1, pos);
                copyArray(temp2, vel);
                break;
