...
{
	private static final long serialVersionUID = -2253202369353695502L;
    ...
    private HashMap<String,AbstractSatellite> satHash = new HashMap<String, AbstractSatellite>();
    private HashMap<String,GroundStation> gsHash = new HashMap<String, GroundStation>();
    ...
    // coverage data
    private transient CoverageAnalyzer ca;
    ...
    public JstSaveClass(JSatTrak app)
    {
        ...
        for (String satName : app.getSatNames()) {
            satHash.put(satName, app.getSatellite(satName));
        }
        for (String gsName : app.getGsNames()) {
            gsHash.put(gsName, app.getGs(gsName));
        }
        
        // get and save app data
        currentJulianDate = app.getCurrentJulianDate();
    ...
    public HashMap<String, AbstractSatellite> getSatHash() {
        return new HashMap<String, AbstractSatellite>(satHash);
    }
    
    public HashMap<String, GroundStation> getGsHash() {
        return new HashMap<String, GroundStation>(gsHash);
    }  
} // JstSaveClass
