...
public class SatSettingsPanel extends javax.swing.JPanel implements java.io.Serializable
{
    ...
    private void iniSatProps()
    {
        ...
        // 3d models
        use3DModelCheckBox.setSelected(satProps.use3dModel());
        threeDModelTextField.setText(satProps.get3DModelPath());
        threeDModelTextField.setEditable(satProps.use3dModel()); // set editable
...
private void browseModelButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_browseModelButtonActionPerformed
    ...
    private boolean saveSettings()
    {
        ...
        {
            // ground track 
        	if(showGroundTrackCheckBox.isSelected())
        		satProps.showGroundTrack();
        	else
        		satProps.hideGroundTrack();
        }
        catch(Exception e)
        {
        ...
        satProps.setShowGroundTrack3D(showGroundTrackCheckBox.isSelected());
        ...
        {
            satProps.set3DModelPath(threeDModelTextField.getText());
